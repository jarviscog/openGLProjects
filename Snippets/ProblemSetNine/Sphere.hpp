...
/**
 * A modified version of Sphere from http://www.songho.ca/opengl/gl_sphere.html
 */
...
Sphere::Sphere(float radius, int sectors, int stacks, bool smooth, int up) : interleavedStride(32)
{
    ...
    programID = LoadShaders( "Exercise3.vertexshader", "Exercise3.fragmentshader" );
    ...
    LightPosID1 = glGetUniformLocation(programID, "LightPosition_worldspace");
...
void Sphere::draw(glm::vec3 lightPos1, glm::vec3 lightPos2, glm::mat4 M, glm::mat4 V, glm::mat4 P, glm::vec4 color, float alpha) const {
    glm::mat4 MVP = P*V*M;
    glUseProgram(programID);
